...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 21, 2018 at 04:18 AM
...
INSERT INTO `user_prestasi` (`id_prestasi`, `nim`, `nama_prestasi`, `peringkat_prestasi`, `tipe_prestasi`, `role_prestasi`, `jenis_prestasi`, `level_prestasi`, `deskripsi_prestasi`, `reward_poin`, `penyelenggara_prestasi`, `tempat_prestasi`, `tgl_prestasi_start`, `tgl_prestasi_end`, `date_modified`) VALUES
(1, '24010314130107', 'dsfds', 'asdas', 1, 'ddfdfsf', 2, '3', 'asd', 0, '', '', '2018-02-07', '0000-00-00', '2018-02-05 12:33:01'),
(4, '24010314130107', 'dfhdfh', 'sdsdf', 1, 'sdfsdfsd', 2, '2', 'sdfsdfsd', 3, '', '', '0000-00-00', '0000-00-00', '2018-02-05 16:38:16'),
...
(8, '24010314130107', 'Coba edit tempat nama penyelenggara', 'jyuara satuuu', 1, 'asfasfasdf', 2, '3', 'asfasfasdf', 4, 'Super soccer', 'sebelah sana', '2018-02-14', '2018-02-15', '2018-02-19 01:08:24');
...
--
ALTER TABLE `user_prestasi`
  MODIFY `id_prestasi` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
